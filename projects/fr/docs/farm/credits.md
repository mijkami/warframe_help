...
- la warframe [Chroma](https://wiki.warframe.com/w/Chroma) vous permettra de doubler les crédits ramassés avec son 4, très utile dans certaines missions (Profit-Taker, caches 1999)
- le [Booster de Crédits](https://wiki.warframe.com/w/Credit_Booster), pas nécessaire mais appréciable
...
- Drops Crédits (utiliser le 4 de Chroma) :
    ...
    - Profit-Taker
- Railjack dans le Voile (haut-niveau)
