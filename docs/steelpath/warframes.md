...
- augmenter le stock/**pool d'énergie** et les moyens de le remplir
   ...
   - **[apport d'énergie](https://wiki.warframe.com/w/Energy_Capacity#Restoring_Energy)** : 
      - **communs / meta** :
        ...
        - [compétence helminth](#helminth) :
            - [**Nourish**](https://wiki.warframe.com/w/Nourish) de Grendel, combo possible avec [Energy Nexus](https://wiki.warframe.com/w/Energy_Nexus) et/ou [Archon Stretch](https://wiki.warframe.com/w/Archon_Stretch) (proc avec [Arc Coil](https://wiki.warframe.com/w/Arc_Coil) du Diriga ou de l'elec sur les griffes de votre compagnon)
            - [Brightbonnet](https://wiki.warframe.com/w/Brightbonnet) de Nokko. Les rebonds du projectile de la compétence ou d'une frame sur les champignons créés permet d'accélérer la régénération d'énergie. Pensez à "spam" contre un mur pour faire rebondir sur des champis très rapidement. Excellent combo avec [Arcane Sculptor](https://wiki.warframe.com/w/Arcane_Sculptor).
