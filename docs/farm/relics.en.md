![Lith Relic Intact](../assets/farm/LithRelicIntact.png){ width="135" align=right }
...
- **Void Traces** for:
    ...
    - crafting your **Corrupted Keys** for farming [corrupted mods](plats.en.md/#good-deals)
    - your **maximum limit** of Void Traces depends on your [Mastery Rank](../beginner/mastery-rank.md)
...
- **Prime equipment blueprints**, more powerful and rare:
    ...
    - duplicates, surplus:
        ...
        - sell them for [Platinum](plats.md), preferably in full sets (ex: all 4 parts of a frame in one sale)
...
??? note "Relic Opening Strategy"

    - make a relic rush frame (Gauss, Titania + helminth gauss, Volt or other)
    - use [AlecaFrame](https://alecaframe.com/) if you're on PC to better understand relic drop values and manage your sales
    ...
    - fast relic drop:
        ...
        - Axi: Apollo on Lua
    - find relic groups:
        - the [Burner discord](https://warframe.market) ([see content/Discord](../content.md/#discord))
...
Use the [page of primes not yet vaulted](https://wiki.warframe.com/w/Prime_Vault#Not_Yet_Vaulted): relics containing them are considered common, unless very recent release.
Some relics are more interesting than others, a mix between rarity and popularity of prime parts:
...
- ??? note "Vaulted Prime parts"
    - [wiki Prime Vault page](https://wiki.warframe.com/w/Prime_Vault)
    ...
    - each time a new prime releases, an older one is vaulted. Current rotation consists of 7 non-vaulted prime warframes (and their weapons/sentinels)
        - consult the [unvaulting page](https://wiki.warframe.com/w/Prime_Vault#Not_Yet_Vaulted) to see "common" relics at the moment

- ??? note "2 sources of vaulted relics"
    - **own an old relic** dropped when a frame/weapon was accessible in the past
    - **spend [Aya](https://wiki.warframe.com/w/Aya)** to buy from [Prime Resurgence](https://wiki.warframe.com/w/Prime_Resurgence) shop:
        ...
        - earning Aya:
            ...
            - [Brute Force](https://www.youtube.com/watch?v=rfV_KoJGvPI) on Deimos (most accessible), do solo or in duo (some objectives become too long with 3-4 players)
            - [Opti Bounties on Cetus](https://www.youtube.com/watch?v=eovwUJXV6Ow) (more profitable but inaccessible for new players, reserve for groups for [later](../content.md/#discord))
...
- **organized group farming** where everyone brings the same relic to increase specific drop chances
    ...
    - ??? note "go through the in-game recruitment channel"
        ...
        - message types:
        - **H [Relic Axi V8] 2/4 rad**: means **H**ost (host/create a group) for Axi V8 relic, already 2 players out of 4, radiant relic for all ==> send him a message **"+1"** / **"inv"** to be invited
...
!!! note "Lith Fissure: Bifrost Echo, Venus Proxima (Railjack)"
    Advantages:
    ...
    - [Athodai](https://wiki.warframe.com/w/Athodai) drops

    Strategy:

    - send a player to the "white dot" indicating a wreck (requires [rank 5 in Piloting Intrinsics](https://wiki.warframe.com/w/Railjack/Intrinsics#Piloting) to see it) with a hack at the end of a corridor (bonus loot Athodai & Nyx/Valkyr relics)
    ...
    - return to Railjack
        ...
        - use [Form Up](https://wiki.warframe.com/w/Form_Up) to tp the whole group
        - use Omni (consumable wheel, auto-equipped in Railjack) to tp solo (requires [Rank 4 in Tactical Intrinsics](https://wiki.warframe.com/w/Railjack/Intrinsics#Tactical))

!!! note "Requiem Fissure: Pago - Kuva Spy"
    - follow build and strategy explained in this [GazTTV video](https://www.youtube.com/watch?app=desktop&v=eKv-KUJmtG8)
    - high drop rate of [60/60 mods](https://wiki.warframe.com/w/Pago)
    - high-level spy: guaranteed Meso/Neo drops
    - opening Requiem relics:
        - Requiem mod drops
        - refine to Flawless (50 traces) for optimization

!!! note "Axi/Neo Fissure: capture/extermination in Void (Hepit, Ukko, Oxomoco, Teshub)"
    - fast & easy missions
        - wide corridors
