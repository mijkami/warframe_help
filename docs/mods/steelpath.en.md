...
- **LEVEL UP YOUR MODS**: farm **credits** and **Endo** see [Farm section](../farm/index.md)
- [farm](../farm/index.md) [**corrupted mods**](https://wiki.warframe.com/w/Corrupted_Mods) (and [apothic mods](https://www.youtube.com/results?search_query=apothic%20farm%20warframe))
- do [arbitration](../content.md/#docs) (alerts + arbitrator shop at relay) to get [galvanized mods](https://wiki.warframe.com/w/Galvanized_Mods).
